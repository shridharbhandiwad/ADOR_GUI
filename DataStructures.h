...
typedef struct {
    ...
    uint16_t min_speed_kmh;         // Minimum speed (km/h) - can be negative
    uint16_t max_speed_kmh;         // Maximum speed (km/h) - can be negative
    uint16_t min_angle_degree;      // Minimum angle (degrees) - can be negative
    uint16_t max_angle_degree;      // Maximum angle (degrees) - can be negative
